...
inc/%.o: ../inc/%.c
	...
	avr-gcc -I"/home/jkw/Store/17 - Speedmaster/ATm2560_Firmware/inc" -I"/home/jkw/Store/17 - Speedmaster/ATm2560_Firmware" -Wall -Os -fpack-struct -fshort-enums -std=gnu99 -funsigned-char -funsigned-bitfields -v -lm -mmcu=atmega2560 -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o"$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
