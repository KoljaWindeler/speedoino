...
void speedo_menu::display(){
	...
	// now the "mode" selector
		...
		state=BMP(0,0,0,M_TOUR_ASSISTS,SM_TOUR_ASSISTS_SPEEDCAM_ON_OFF,1,1);
	...
	// now the "mode" selector
	else if(floor(state/100)==BMP(0,0,0,0,0,7,4)) { // 000461X
		if(state%10==9){ // "up" key
