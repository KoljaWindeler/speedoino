...
private:
	...
	int write_navi_file(int8_t* pointer_of_text_buffer,uint8_t* text_buffer,uint32_t* loaded_latitude,uint32_t* loaded_longitude,bool* append_to_write_file,int8_t* points_to_copy, int8_t* state, int8_t* n, FIL* read_file,int32_t* best_dist_seek);
};
extern poi_finder* pPOI_Finder;
